<header class="main-header">
	...
	<a href="home" class="logo">
		...
		<span class="logo-mini">
			...
			<img class="img-responsive" src="views/img/template/sample.png" style="padding: 10px " >
		...
		<span class="logo-lg">
			...
			<img class="img-responsive" src="views/img/template/sample.png" style="padding: 0px ; max-width:50%; height:auto;">
